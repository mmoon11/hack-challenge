...
def create_application():
    ...
    if category_id is None:
        return failure_response("Category not found")
    if (body.get("title") is None) or (body.get("club_name") is None) or (body.get("description") is None) or (body.get("app_link") is None) or (body.get("club_link") is None) or (body.get("image_link") is None) or (body.get("chat_link") is None) or (body.get("month") is None) or (body.get("day") is None) or (body.get("year") is None) or (body.get("hour") is None) or (body.get("minute") is None):
    ...
    new_application = Application(title=body.get("title"), club_name=body.get("club_name"), 
                                  ...
                                  club_link=body.get("club_link"), image_link=body.get("image_link"), chat_link=body.get("chat_link"), month=body.get("month"), day=body.get("day"), 
