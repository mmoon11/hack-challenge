...
def create_application():
    ...
    (body.get("app_link") is None) or (body.get("club_link") is None) or (body.get("image_link") is None) or 
    (body.get("chat_link") is None) or (body.get("month") is None) or (body.get("day") is None) or 
